...
void I2C_HighSpeed(void){
    I2C0_MTPR_R|=0x80;    //TPR: Timer Period=1    Fclk=40 [MHz]
                          ...
                          //SCL_freq=3.33 [MHz]
    I2C0_MSA_R=(0x7<< 1);             //Carga dirección  y escritura o lectura
...
void I2C_GlitchSupp(void){
    //  (TM4C123GH6PM)
    I2C0_MCR_R|=0x10;              //Habiltación de Supresión de GLitch GFE 1 pulso de reloj
    I2C0_MCR2_R|=0x50;             //Ancho del pulso de 4 ciclos de reloj GFPW
//    //  (TM4C1294NCPDT)
